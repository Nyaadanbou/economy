...
import cc.mewcraft.economy.command.command.BalanceAccCommand;
import cc.mewcraft.economy.command.command.BalanceCommand;
import cc.mewcraft.economy.command.command.BalanceTopCommand;
import cc.mewcraft.economy.command.command.CurrencyCommand;
import cc.mewcraft.economy.command.command.EconomyCommand;
import cc.mewcraft.economy.command.command.InternalCommand;
import cc.mewcraft.economy.command.command.PayCommand;
...
public class CommandManager {
    ...
    public static final CloudKey<EconomyPlugin> PLUGIN = CloudKey.of("economy:plugin", TypeToken.get(EconomyPlugin.class));
    ...
    public CommandManager(EconomyPlugin plugin) throws Exception {
