...
public class AccountManager {
     ...
     * Creates, saves, and caches an Account.
     * <p>
     * If the Account with specific name is already loaded or exists in database, this method will do nothing.
     *
    ...
    public void createAccount(@NonNull String nickname) {
        ...
        createAccount(OfflineModeProfiles.getUniqueId(nickname));
    }
